<div>
  <div class="container">
    <h3 class=" text-capitalize text-center text-dark bg-secondary"><span>Department : </span>Computer Science</h3>
  </div>
  <div class="container">
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../public/logos/p3.jpg" height="350px" class="w-100" alt="...">
        </div>
