        ...
        <form class="container form-group">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="parentid" aria-label="Default select example"
              onchange="detectChild(this.value);">
...
<script>
  ...
  function updateMenudetails() {
    ...
    $.post("../ajax/updateShowdatamodal.php", { uid: uid, name: name, title: title, parentid: parentid, orderlist: orderlist, icon: icon, url: url }, function (data, status) {
      fetchData();
